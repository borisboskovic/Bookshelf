...
namespace BookshelfAPI.Data.Migrations
{
    ...
    [Migration("20210321161159_AddedIdentity")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BookshelfAPI.Data.Models.Book", b =>
                {
                    ...
                    b.HasIndex(new[] { "AutId" }, "Writen By_FK");

                    b.ToTable("Book");
                });

            modelBuilder.Entity("BookshelfAPI.Data.Models.BookshelfRole", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("BookshelfAPI.Data.Models.Book", b =>
                {
                    b.HasOne("BookshelfAPI.Data.Models.Author", "Aut")
                        .WithMany("Books")
                        .HasForeignKey("AutId")
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRoleClaim<int>", b =>
                {
                    b.HasOne("BookshelfAPI.Data.Models.BookshelfRole", null)
                        .WithMany()
